...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(AppComponent, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Navigation2.default, { searchText: this.state.searchText, navigations: this.state.navigations })
				);
			}
		}]);
	...
	_reactDom2.default.render(_react2.default.createElement(AppComponent, null), app);
	...
	var Navigation = function (_React$Component) {
		...
		_createClass(Navigation, [{
			...
			value: function renderNav() {
				...
				if (this.props.navigations == undefined) return _react2.default.createElement(
					"p",
					null,
					"Loading data..."
				);
	   ...
	   */
			...
			value: function filterNav(navData, filterText) {
				...
				var fullData = _underscore2.default.union(parentNav, matchNav, machedParentNav);
