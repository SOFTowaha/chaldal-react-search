...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = function (_React$Component) {
		...
		_createClass(AppComponent, [{
			...
			value: function searchNavigation(searchText) {
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					null,
					_react2.default.createElement(_Search2.default, { handleChange: this.searchNavigation.bind(this), searchText: this.state.searchText }),
					_react2.default.createElement(_Navigation2.default, { searchText: this.state.searchText, navigations: this.props.navigations })
				);
			}
		}]);
	...
	var navigations = [{
		...
		_reactDom2.default.render(_react2.default.createElement(AppComponent, { navigations: navigations }), app);
		...
		_createClass(Search, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					null,
					_react2.default.createElement("input", { type: "text", onChange: this.handleChange.bind(this), ref: "searchInput", value: this.props.searchText })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonq = __webpack_require__(163);

	var _jsonq2 = _interopRequireDefault(_jsonq);
	...
	var Navigation = function (_React$Component) {
	   ...
	   */
			...
			key: "filterNav",
			value: function filterNav(navData, filterText) {
				...
				var parentNav = [];
				var matchNav = [];
				navData.forEach(function (nav, key) {
				...
				if (matchNav.length > 0) {
					matchNav.forEach(function (matchedItem) {
				...
				navData = _jsonq2.default.union(parentNav, machedParentNav, matchNav);
				//console.log(navData);
	   ...
	   */
			...
			key: "generateTree",
			value: function generateTree(data) {
	   ...
	   */
			...
			key: "generateElem",
			value: function generateElem(item) {
				var _this2 = this;

				var rows = [];

				item.forEach(function (nav, key) {
					var child = '';

					if (nav.children && nav.children.length > 0) {
						var child = _this2.generateElem(nav.children);
					}
